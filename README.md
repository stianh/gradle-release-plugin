#Gradle release plugin (Git and Subversion) [![Build Status](https://secure.travis-ci.org/stianh/gradle-release-plugin.png?branch=master)](http://travis-ci.org/stianh/gradle-release-plugin)
