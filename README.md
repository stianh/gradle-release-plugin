Gradle release plugin (Git and Subversion) [![Build Status](http://travis-ci.org/stianh/gradle-release-plugin.png?branch=master)](http://travis-ci.org/stianh/gradle-release-plugin)
==========================================
